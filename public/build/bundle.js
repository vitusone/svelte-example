...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h2 = element("h2");
    			t6 = text(/*count*/ ctx[0]);
    			add_location(button0, file, 4, 0, 33);
    			add_location(button1, file, 7, 0, 86);
    			add_location(button2, file, 10, 0, 139);
    			add_location(h2, file, 14, 0, 189);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler_2 = () => $$invalidate(0, count = 0);
